...
struct FloatType
{
    ...
    FloatType add(float other)
    {
        return FloatType(other + *value);
    }

    FloatType subtract(float other)
    {
        return FloatType(other - *value);
    }

    FloatType multiply(float other)
    {
        return FloatType(other * *value);
    }

    FloatType divide(float other)
    {
        if (other == 0.0f)
        {
            std::cout << std::endl << "warning, floating point division by zero returns 'inf' !" << std::endl;
        }
        return FloatType(*value / other);
    }
...
struct DoubleType
{
    ...
    DoubleType add(float other)
    {
        return DoubleType(other + *value);
    }

    DoubleType subtract(float other)
    {
        return DoubleType(other - *value);
    }

    DoubleType multiply(float other)
    {
        return DoubleType(other * *value);
    }

    DoubleType divide(double other)
    {
        if (other == 0.0)
        {
            std::cout << std::endl << "warning, floating point division by zero returns 'inf' !" << std::endl;
...
struct IntType
{
    ...
    IntType add(float other)
    {
        return IntType(other + *value);
    }

    IntType subtract(float other)
    {
        return IntType(other - *value);
    }

    IntType multiply(float other)
    {
        return IntType(other * *value);
    }

    IntType divide(int other)
    {
        if (other == 0)
        {
